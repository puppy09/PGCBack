...
def hacer_prediccion(usuario):
    try:
        ...
        new_medidas = Medidas(id_usuario=usuario.id_usuario, peso=peso, altura=altura, cuello=cuello, pecho=pecho, abdomen=abdomen, cadera=cadera, muslo=muslo, bicep=bicep)
